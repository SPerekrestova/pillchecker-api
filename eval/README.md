...
2. `component_timings_ms` repeats those keys and adds `critical_path` plus `slowest_component_ms`; `slowest_component` names the largest timing bucket for that record.
